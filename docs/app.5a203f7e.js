...
},{"../services/quationsService":"../js/services/quationsService.js"}],"../../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./..\\..\\..\\assets\\img\\home.png":[["home.7c8328ea.png","../assets/img/home.png"],"../assets/img/home.png"],"./..\\..\\..\\assets\\img\\hotel.jpg":[["hotel.7ee2ff1a.jpg","../assets/img/hotel.jpg"],"../assets/img/hotel.jpg"],"./..\\..\\..\\assets\\img\\services.jpg":[["services.cc0e3a87.jpg","../assets/img/services.jpg"],"../assets/img/services.jpg"],"./..\\..\\..\\assets\\img\\contact.jpg":[["contact.5d9ea2d3.jpg","../assets/img/contact.jpg"],"../assets/img/contact.jpg"],"./..\\..\\..\\assets\\img\\basket.jpg":[["basket.2f1c9bf7.jpg","../assets/img/basket.jpg"],"../assets/img/basket.jpg"],"./..\\..\\..\\assets\\img\\hotelIcon.png":[["hotelIcon.936b9856.png","../assets/img/hotelIcon.png"],"../assets/img/hotelIcon.png"],"./..\\..\\..\\assets\\img\\serviceIcon.png":[["serviceIcon.62a0f3b1.png","../assets/img/serviceIcon.png"],"../assets/img/serviceIcon.png"],"./..\\..\\..\\assets\\img\\contactIcon.png":[["contactIcon.41e4ef4f.png","../assets/img/contactIcon.png"],"../assets/img/contactIcon.png"],"./..\\..\\..\\assets\\img\\basketIcon.png":[["basketIcon.c7e34b78.png","../assets/img/basketIcon.png"],"../assets/img/basketIcon.png"],"_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../js/components/HomeComponent/home.js":[function(require,module,exports) {
"use strict";
...
var createCircleItem = function createCircleItem(circleCss, secondary, href, info) {
  var html = "<a href=\"".concat(href, "\"><div class=\"circle ").concat(circleCss, "\"></div></a>");
  $(".".concat(circleCss)).ready(function () {
    $(".".concat(circleCss)).mouseover(function () {
      $(".".concat(secondary)).css("display", "block");
      $('.infoSpan').text(info);
    });
    $(".".concat(circleCss)).mouseleave(function () {
      $(".".concat(secondary)).css("display", "none");
    });
  });
  return html;
};
...
var home = function home() {
  ...
  var html = "\n  <div class=\"homeBackground\"></div>\n  <div class=\"secondaryHotel\"></div>\n  <div class=\"secondaryServices\"></div>\n  <div class=\"secondaryContact\"></div>\n  <div class=\"secondaryBasket\"></div>\n  <div class=\"homeContainer\">\n    <div class=\"homeCenter\">\n    <span class=\"welcomeSpan\">Welcome in IT SPA</span>\n      <div class=\"circleContainer\">\n        ".concat(createCircleItem('hotelCircle', 'secondaryHotel', 'hotel', 'Over 30 luxury apartments'), "\n        ").concat(createCircleItem('serviceCircle', 'secondaryServices', 'services', 'Rich leisure offer'), "\n        ").concat(createCircleItem('contactCircle', 'secondaryContact', 'contact', '24 hours a day service'), "\n        ").concat(createCircleItem('basketCircle', 'secondaryBasket', 'basket', "Don't hesitate to be our guest"), "\n      </div>\n      <span class=\"infoSpan\">We are one of the most luxurious hotel & spa in the world</span>\n    </div>\n  </div>");
...
exports.home = home;
},{"../../common/QuotationBuilder":"../js/common/QuotationBuilder.js","./home.scss":"../js/components/HomeComponent/home.scss"}],"../js/common/Offers.js":[function(require,module,exports) {
"use strict";
...
var createLogOutButton = function createLogOutButton() {
  var html = "<li class=\"item power\" id=\"logOutButton\"><a class=\"link\"><i class=\"fas fa-power-off\"></i></a></li>";
